...
def main(mode='folder'):
    ...
    if mode == 'folder':
        opt['dataroot_gt'] = 'datasets/YTB/GT'
        opt['dataroot_lq'] = 'datasets/YTB/LR'  # noqa E501
        opt['meta_info_file'] = 'basicsr/data/meta_info/basicsr/data/meta_info/YTB_test_GT.txt'  # noqa E501
