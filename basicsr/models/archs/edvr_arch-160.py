...
class EDVR(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_hr = nn.Conv2d(67, 64, 3, 1, 1)
 #       self.conv_hr = nn.Conv2d(64, 64, 3, 1, 1)
        self.conv_last = nn.Conv2d(64, 3, 3, 1, 1)
        self.conv_hr2 = nn.Conv2d(64, 64, 3, 1, 1)
  #      self.conv_hr2 = nn.Conv2d(6, 12, 3, 1, 1)
  #      self.conv_hr3 = nn.Conv2d(12, 3, 3, 1, 1)
        # activation function
        self.lrelu = nn.LeakyReLU(negative_slope=0.1, inplace=True)

    def forward(self, x, hr_3d):
       ...
       # out = torch.cat((out,hr_3d),dim=1)
      #  out = self.lrelu(self.conv_hr2(out))
      #  out = self.lrelu(self.conv_hr3(out))
        return out
